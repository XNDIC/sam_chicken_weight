...
def efficientvit_seg_b1(dataset: str, **kwargs) -> EfficientViTSeg:
    from efficientvit_master.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b1
...
def efficientvit_seg_b2(dataset: str, **kwargs) -> EfficientViTSeg:
    from efficientvit_master.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b2
...
def efficientvit_seg_b3(dataset: str, **kwargs) -> EfficientViTSeg:
    from efficientvit_master.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b3
